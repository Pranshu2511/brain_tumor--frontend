...
const AdminReg = () => {
  ...
  const handleRegister = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://backend-brain-9q15.onrender.com/admin-register", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://backend-brain-9q15.onrender.com/verify-admin-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
