...
const AdminFeedback = () => {
  ...
  const fetchFeedback = async () => {
    try {
      const response = await fetch("https://backend-brain-9q15.onrender.com/get-feedback");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://backend-brain-9q15.onrender.com/api/delete_feedback/${id}`, {
        method: "DELETE",
      });
